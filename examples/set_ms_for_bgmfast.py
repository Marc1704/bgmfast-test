...
sel_columns_ms = ['G', 'BP_RP', 'Parallax', 'PopBin', 'Age', 'longitude', 'latitude', 'IniMass']
...
sel_columns_ms_err = ['Gerr', 'BpRperr', 'parallaxerr', 'PopBin', 'Age', 'longitude', 'latitude', 'IniMass']
...
sel_columns_ms_final = ['Gerr', 'BpRperr', 'PopBin', 'Age', 'longitude', 'latitude', 'parallaxerr', 'MassOut', 'Mvarpi']
